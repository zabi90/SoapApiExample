package com.example.soapapiexample.adapters.tikxml
...
import com.example.soapapiexample.models.tikxml.response.Country
...
class CountryListAdapter(context:Context) : BaseRecyclerAdapter<Country, CountryListAdapter.CountryViewHolder>(context) {
    ...
    inner class CountryViewHolder(itemView:View):RecyclerView.ViewHolder(itemView){
        fun bindItem(country: Country){
            itemView.name.text = HtmlCompat.fromHtml(country.name,HtmlCompat.FROM_HTML_MODE_LEGACY)
